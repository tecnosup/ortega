...
export default function CtaFinal() {
  ...
  return (
    <section className="py-20 md:py-28 bg-[#0D0D0D] relative overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto px-4 sm:px-6 text-center flex flex-col gap-6 md:gap-8 items-center">
        <div className="w-16 h-px bg-gradient-to-r from-transparent via-[#C9A84C]/40 to-transparent" />

        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#F5E6C8] leading-tight">
          Pronto para uma nova<br />
          <span className="text-[#C9A84C]">versão de você?</span>
        </h2>

        <p className="text-sm sm:text-base text-[#F5E6C8]/50 leading-relaxed max-w-md">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto justify-center">
          <a
            href="/agendamento"
            className="inline-flex items-center justify-center px-8 py-4 bg-[#C9A84C] text-[#0A0A0A] text-sm font-bold tracking-widest uppercase hover:bg-[#E2C06A] transition-all duration-300"
          >
            Agendar horário
          </a>
          {whatsapp && (
            <a
              ...
              className="inline-flex items-center justify-center px-8 py-4 border border-[#C9A84C]/40 text-[#C9A84C] text-sm tracking-wider uppercase hover:border-[#C9A84C] hover:bg-[#C9A84C]/05 transition-all duration-300"
            >
              WhatsApp
            </a>
          )}
