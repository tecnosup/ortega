...
export const demoSettings: LandingSettings = {
  ...
  sobreTexto:
    "A Ortega nasceu da paixão pelo artesanato da barbearia tradicional aliado ao estilo contemporâneo. Em nosso espaço, você encontra profissionais dedicados, ambiente premium e os melhores produtos do mercado. Mais do que um corte, oferecemos uma experiência completa de cuidado masculino.",
