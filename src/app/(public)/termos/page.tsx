  ...
  return (
    <section className="min-h-screen pt-28 pb-24 bg-white">
      <div className="max-w-2xl mx-auto px-6">
        ...
        <div className="prose prose-gray text-gray-600 leading-relaxed space-y-6">
          ...
          <h2 className="text-xl font-semibold text-gray-900">2. Uso do serviço</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900">3. Responsabilidades</h2>
